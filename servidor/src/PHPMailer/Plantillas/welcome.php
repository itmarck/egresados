											...
											<tr>
												<td width="260" valign="top">
													<table  border="0" cellpadding="0" cellspacing="0" width="100%" style="box-shadow: 2px 2px 20px" >
														<tr>
															<td>
																<img src="https://i.postimg.cc/JnC8bTNc/2019-08-03-4.png" alt="" width="100%" height="140" style="display: block;" />
															</td>
														</tr>
														<tr>
															<td bgcolor="#0D47A1" height="65px" style="color: rgb(255, 255, 255);  text-align: center;   font-size: 16px; line-height: 20px;">
                                                                Ver noticias que otros egresados comparten sobre su situacion profesional
                                                            </td>
														</tr>
													</table>
												</td>
												...
												<td width="260" valign="top">
													<table border="0" cellpadding="0" cellspacing="0" width="100%" style="box-shadow: 2px 2px 20px">
														...
														<tr>
                                                                <td bgcolor="#0D47A1" height="65px" style="color: rgb(255, 255, 255);  text-align: center;   font-size: 16px; line-height: 20px;">
                                                                        Mantener un control sobre tus estudios y experiencia 
                                                            </td>
														</tr>
													</table>
												</td>
										...
										<table border="0" cellpadding="0" cellspacing="0">
											<tr>
												<td style=" font-size: 12px; font-weight: bold;">
													<a href="http://unprg.xyz" style="box-shadow: 2px 2px 10px 2px #000000 ; padding:15px ; color: #ffffff; text-decoration: none;">
                                                        Visitanos
                                                    </a>
												</td>
