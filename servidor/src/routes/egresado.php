...
$app->get('/api/carreras/{codigo}',function(Request $request){
  ...
  try {
    $data = $this->db->query("SELECT E.codigo,E.codigoEscuela,EP.nombre as nombreEscuela,U.nombre as universidad,codigoPersona,codigoAdmision,A.nombre as Admision,A.fechaAdmision as fechaAdmision,fechaInicio,fechaTermino FROM egresado E
