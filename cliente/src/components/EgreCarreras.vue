        ...
        <v-layout row wrap>
          ...
          <v-flex xs12>
            <v-card>
              ...
              <v-card-actions>
                <v-spacer></v-spacer>
                <v-btn flat v-if="isEdit" @click="dialog = true">
                  <v-icon left>add</v-icon>
                  Titulacion
                </v-btn>
                <v-btn flat v-if="isEdit" @click="editar" type="submit">
                  Editar
                </v-btn>
                <v-btn flat v-else @click="agregar" type="submit">
                  Agregar
                </v-btn>
                <v-btn flat @click="nuevo">Limpiar</v-btn>
              </v-card-actions>
            </v-card>
          </v-flex>
        </v-layout>
...
export default {
  ...
  methods: {
    ...
    cargarLista() {
      get("carreras/" + this.dni).then(res => (this.listaCarreras = res.data));
    },
    cargarUniversidades() {
